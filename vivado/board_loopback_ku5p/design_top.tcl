...
proc create_hier_cell_hier_mac_0 { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_SLOT_2_INTF_TYPE {xilinx.com:display_xxv_ethernet:user_int_ports:2.0} \
 ] $system_ila_tx
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets Conn2] [get_bd_intf_pins rx_xgmii] [get_bd_intf_pins system_ila_tx/SLOT_2_USER_INT_PORTS]
  ...
  connect_bd_intf_net -intf_net xg_mac_0_rx_maxis [get_bd_intf_pins axis_data_fifo_tx/S_AXIS] [get_bd_intf_pins xg_mac_0/rx_maxis]
  ...
  connect_bd_net -net rst_xxv_ethernet_0_156M_2_peripheral_aresetn [get_bd_pins axis_data_fifo_tx/s_axis_aresetn] [get_bd_pins rst_xxv_ethernet_0_156M_rx/peripheral_aresetn]
  ...
  connect_bd_net -net rx_clock [get_bd_pins rx_clock] [get_bd_pins axis_data_fifo_tx/s_axis_aclk] [get_bd_pins rst_xxv_ethernet_0_156M_rx/slowest_sync_clk] [get_bd_pins xg_mac_0/rx_clock]
  connect_bd_net -net rx_reset [get_bd_pins rx_reset] [get_bd_pins rst_xxv_ethernet_0_156M_rx/ext_reset_in] [get_bd_pins system_ila_tx/probe1]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets rx_reset]
  ...
  connect_bd_net -net tx_reset [get_bd_pins tx_reset] [get_bd_pins rst_xxv_ethernet_0_156M_tx/ext_reset_in] [get_bd_pins system_ila_tx/probe0]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets tx_reset]
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set gt_rxp_in_0 [ create_bd_port -dir I gt_rxp_in_0 ]
  set gt_txp_out_0 [ create_bd_port -dir O gt_txp_out_0 ]
  set gt_txn_out_0 [ create_bd_port -dir O gt_txn_out_0 ]
  set gt_rxn_in_0 [ create_bd_port -dir I gt_rxn_in_0 ]
  ...
  connect_bd_intf_net -intf_net gt_ref_1 [get_bd_intf_ports gt_ref] [get_bd_intf_pins xxv_ethernet_0/gt_ref_clk]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M01_AXI [get_bd_intf_pins xxv_ethernet_0/s_axi_0] [get_bd_intf_pins microblaze_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net xxv_ethernet_0_mii_rx_0 [get_bd_intf_pins xxv_ethernet_0/mii_rx_0] [get_bd_intf_pins hier_mac_0/rx_xgmii]

  # Create port connections
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins lmb_bram_if_cntlr_mb_data/LMB_Clk] [get_bd_pins lmb_bram_if_cntlr_mb_inst/LMB_Clk] [get_bd_pins mdm_0/S_AXI_ACLK] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins xxv_ethernet_0/dclk] [get_bd_pins xxv_ethernet_0/s_axi_aclk_0]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins proc_sys_reset_0/dcm_locked]
  connect_bd_net -net gt_rxn_in_0_1 [get_bd_ports gt_rxn_in_0] [get_bd_pins xxv_ethernet_0/gt_rxn_in_0]
  connect_bd_net -net gt_rxp_in_0_1 [get_bd_ports gt_rxp_in_0] [get_bd_pins xxv_ethernet_0/gt_rxp_in_0]
  connect_bd_net -net mdm_0_Debug_SYS_Rst [get_bd_pins hier_mac_0/mb_debug_sys_rst] [get_bd_pins mdm_0/Debug_SYS_Rst] [get_bd_pins proc_sys_reset_0/mb_debug_sys_rst]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins mdm_0/S_AXI_ARESETN] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins xxv_ethernet_0/s_axi_aresetn_0] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN]
  ...
  connect_bd_net -net tx_reset_1 [get_bd_pins xlconstant_0/dout] [get_bd_pins xxv_ethernet_0/tx_reset_0]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconstant_clksel/dout] [get_bd_pins xxv_ethernet_0/rxoutclksel_in_0] [get_bd_pins xxv_ethernet_0/txoutclksel_in_0]
  ...
  connect_bd_net -net xxv_ethernet_0_gt_txn_out_0 [get_bd_ports gt_txn_out_0] [get_bd_pins xxv_ethernet_0/gt_txn_out_0]
  connect_bd_net -net xxv_ethernet_0_gt_txp_out_0 [get_bd_ports gt_txp_out_0] [get_bd_pins xxv_ethernet_0/gt_txp_out_0]
  connect_bd_net -net xxv_ethernet_0_tx_mii_clk_0 [get_bd_pins xxv_ethernet_0/tx_mii_clk_0] [get_bd_pins hier_mac_0/rx_clock] [get_bd_pins hier_mac_0/tx_clock] [get_bd_pins xxv_ethernet_0/rx_core_clk_0]
  ...
  connect_bd_net -net xxv_ethernet_0_user_tx_reset_0 [get_bd_pins xxv_ethernet_0/user_tx_reset_0] [get_bd_pins hier_mac_0/tx_reset] [get_bd_pins xxv_ethernet_0/rx_reset_0]
